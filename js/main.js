$(document).ready(() => {
  ...
  menuAnimation.to(".overlay-menu--grey", {
    duration: 1,
    ease: "power4",
    y: 0,
  });
  menuAnimation.to(
    ".overlay-menu",
    { duration: 0.8, ease: "power4", y: 0 },
    "-=0.7"
  );
  menuAnimation.to(
    ".link-menu",
    { duration: 0.5, y: 0, opacity: 1, ease: "power4", stagger: 0.2 },
    "-=0.5"
  );
  ...
  heroTl.to(".hero__title--text span", {
    duration: 2,
    ease: "power4",
    y: 0,
    rotation: 0,
  ...
  heroTl.fromTo(
    [".hero__content--social .subtitle", ".hero__content--intro .subtitle"],
    { y: 50, opacity: 0 },
  ...
  aboutTl.fromTo(".about__resume", { y: 200 }, { stagger: 0.1, y: 0 });
  aboutTl.fromTo(
    ".about__text p",
    { y: 100, opacity: 0 },
  ...
  skillsTl.fromTo(".box", { scale: 0.8 }, { stagger: 0.1, scale: 1 }, "-=.5");
